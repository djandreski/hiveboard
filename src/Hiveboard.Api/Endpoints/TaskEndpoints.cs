...
public static class TaskEndpoints
{
    public static void MapTaskEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/projects/{projectId:guid}/tasks", ListProjectTasks)
            ...
            .WithDescription("Auth: Any agent API key. Lists project tasks and supports optional status, agentId, and epicId filters.")
        ...
        group.MapPost("/projects/{projectId:guid}/tasks", CreateTask)
            ...
            .WithDescription("Auth: Orchestrator agent API key. Creates a backlog task under the selected project.")
        ...
        group.MapGet("/tasks/{id:guid}", GetTaskById)
            ...
            .WithDescription("Auth: Any agent API key. Returns full task context including relationships, notes, events, and decisions.")
        ...
        group.MapPatch("/tasks/{id:guid}", UpdateTask)
            ...
            .WithDescription("Auth: Orchestrator agent API key. Updates task fields and handles assignment side-effects.")
