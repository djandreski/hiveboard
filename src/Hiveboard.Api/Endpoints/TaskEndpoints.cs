...
public static class TaskEndpoints
{
    public static void MapTaskEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/projects/{projectId:guid}/tasks", CreateTask)
            ...
            .WithDescription("Auth: Coordinator/admin key or the configured project orchestrator API key. Creates a backlog task under the selected project.")
        ...
        group.MapPatch("/tasks/{id:guid}", UpdateTask)
            ...
            .WithDescription("Auth: Coordinator/admin key or the configured project orchestrator API key. Updates task fields and handles assignment side-effects.")
